...
export function PublicNav() {
  ...
  return (
    ...
    {/* Mobile menu — portal to document.body so it's never clipped by sticky/overflow parents */}
    {mobileOpen && createPortal(
      <div className="fixed inset-0 z-[9999] bg-[var(--navy-950)] flex flex-col lg:hidden">
        {/* Header bar */}
